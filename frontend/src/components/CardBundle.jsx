...
const CardBundle = ({ text, subtext, image, price, id }) => {
  ...
  return (
    <div className="relative flex flex-col justify-center items-center px-3 pt-4 pb-5 md:w-full w-[500px] mx-auto bg-white  rounded-2xl mb-4 my-5 ">
      ...
      <button
        onClick={() => navigate(`/bundleDetails/${id}`)}
        className="absolute bottom-3 bg-bgBlue font-bold text-white p-4 rounded-lg text-[20px]"
      >
        SHOP NOW
      </button>
    </div>
